...
import com.chelsi.klinikapps.adapter.AdapterListDoctors
import com.chelsi.klinikapps.adapter.MenuIcon
import com.chelsi.klinikapps.model.ModelIcon
import com.chelsi.klinikapps.model.ModelListDoctors
...
class DoctorsPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val menudokter = listOf(
            ...
            ModelListDoctors("Dr.Guy Hawkins",R.drawable.dokter2,R.drawable.bintang,"Dentist","(85 reviews)","5.0"),
            ModelListDoctors("Dr.Jane Cooper",R.drawable.dokter3,R.drawable.bintang,"Cardiologist","(44 reviews)","4.9"),
